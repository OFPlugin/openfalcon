...
// GitHub release endpoint for the public repo.
const GITHUB_RELEASE_URL = 'https://api.github.com/repos/ShowPilotFPP/ShowPilot/releases/latest';
...
function fetchLatestRelease() {
  return new Promise((resolve, reject) => {
    const req = https.get(GITHUB_RELEASE_URL, {
      headers: {
