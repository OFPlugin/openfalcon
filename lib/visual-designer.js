...
<div class="of-page-wrap">
  ...
  <!-- Now Playing — always visible (v0.32.7+).
...
<div {after-hours-message}>
  ...
  nowPlaying: {
    ...
    render(p) {
      // v0.32.7+: this block is no longer wrapped in {jukebox-dynamic-container}.
...
<div>
  ...
  nextUp: {
    ...
    defaultProps: { titleColor: '#dc2626' },
    render(p) {
      // v0.32.7+: standalone block for the upcoming song. Always visible.
